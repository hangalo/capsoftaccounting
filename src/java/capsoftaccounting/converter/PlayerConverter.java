 ...
 * @author praveen
 */
@FacesConverter(value = "playerConConverter")
public class PlayerConverter implements Converter {
    
    
    
     private static Map<String, Player> mapa = new HashMap<String, Player>();
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value instanceof Player) {
            ...
            System.out.println("getAsString >>>>>>>>>>>>>>>>>>>>>>>>>>>>>"+mapa.put(String.valueOf(f.getId()), f));
